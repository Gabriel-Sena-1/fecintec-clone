...
//if(!empty($_SESSION) && isset($_SESSION) && isset($_SESSION['avaliador'])) 
...
<body>
    ...
    $acao = $_GET['action'];
    if ($acao == 'ver') {
        $notas = buscarNotas($id, $_SESSION['avaliador']['id']);
    }
    ;
    ?>
    ...
    <form action="../../Service/processaAvaliacao.php" method="post">
        ...
        <input type="hidden" name="idTrabalho" value="<?php echo $id; ?>">
        <input type="hidden" name="idAvaliador" value="<?php echo $_SESSION['avaliador']['id']; ?>">
